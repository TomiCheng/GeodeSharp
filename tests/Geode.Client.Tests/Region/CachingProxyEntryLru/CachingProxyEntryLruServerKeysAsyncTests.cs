...
/// </summary>
public class CachingProxyEntryLruServerKeysAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(ServerKeysAsync_AlreadyCancelledToken_Throws);
        try
        {
