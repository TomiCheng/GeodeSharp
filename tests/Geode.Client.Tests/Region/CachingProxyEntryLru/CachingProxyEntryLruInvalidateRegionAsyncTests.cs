...
/// </summary>
public class CachingProxyEntryLruInvalidateRegionAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(CachingProxyEntryLruInvalidateRegionAsyncTests);
        try
        {
