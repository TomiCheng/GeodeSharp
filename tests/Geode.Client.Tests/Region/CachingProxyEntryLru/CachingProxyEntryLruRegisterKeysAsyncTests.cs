...
/// </summary>
public class CachingProxyEntryLruRegisterKeysAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(CachingProxyEntryLruRegisterKeysAsyncTests);
        try
        {
