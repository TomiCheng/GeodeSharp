...
[SuppressMessage(
    ...
    Justification = "xUnit [CollectionDefinition] uses the class name as the collection identifier; renaming would break the [Collection(nameof(GeodeCollection))] usage convention.")]
