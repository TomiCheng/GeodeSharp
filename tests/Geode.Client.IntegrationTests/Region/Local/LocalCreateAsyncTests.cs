...
/// <c>Geode.Client.Tests.Region.Local.LocalCreateAsyncTests</c>. Pool exists
/// on the cache but the region is <see cref="RegionShortcut.Local"/> — strict
/// create stays pure-local regardless.
/// </summary>
[Collection(nameof(GeodeCollection))]
public class LocalCreateAsyncTests(GeodeFixture fx, IGeodeCacheFactory factory)
{
