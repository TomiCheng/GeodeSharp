...
/// </summary>
public class CachingProxyEntryLruUnregisterAllKeysAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(CachingProxyEntryLruUnregisterAllKeysAsyncTests);
        try
        {
