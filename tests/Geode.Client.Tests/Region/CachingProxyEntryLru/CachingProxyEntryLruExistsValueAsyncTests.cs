...
/// </summary>
public class CachingProxyEntryLruExistsValueAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(ExistsValueAsync_AlreadyCancelledToken_Throws);
        try
        {
