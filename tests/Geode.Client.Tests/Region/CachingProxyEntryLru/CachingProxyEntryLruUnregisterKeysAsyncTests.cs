...
/// </summary>
public class CachingProxyEntryLruUnregisterKeysAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(CachingProxyEntryLruUnregisterKeysAsyncTests);
        try
        {
