...
/// </summary>
public class CachingProxyEntryLruUnregisterRegexAsyncTests(IGeodeCacheFactory factory)
{
    ...
    {
        const string cacheName = nameof(CachingProxyEntryLruUnregisterRegexAsyncTests);
        try
        {
